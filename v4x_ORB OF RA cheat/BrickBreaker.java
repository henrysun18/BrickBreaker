...
public class BrickBreaker extends JFrame implements ActionListener, KeyListener{
	...
	int BALL_Y=500; //i think BALL_SOUTH / BALL_EAST variables would be inefficient
	int BALL_X_VEL=0;
	int BALL_Y_VEL=0;
			...
			public void paintComponent(Graphics g){ //objects to print on the screen
				...
				if (activePowerUp){
					...
					if (powerUp<=3) //ORB OF RA = 1/7 chance
						...
						powerUp=7;
					switch (powerUp){
						case 1: g.drawImage(power3.getImage(),POWERUP_X,POWERUP_Y,50,50,null); break;
						case 4: g.drawImage(power3.getImage(),POWERUP_X,POWERUP_Y,50,50,null); break;
	...
	public void menu(){
		...
		setSize(1000,800); //actually 994*690
